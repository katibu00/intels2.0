...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>IntelS : @yield('PageTitle')</title>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
				...
				<img src="/uploads/no-image.jpg" width="60" alt="school logo" class="cover-photo rounded"/>
				{{-- <h2>DemoSchool</h2> --}}
            </a>
        ...
        ***********************************-->
        <div class="footer">
            ...
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">IntelliSAS</a> 2021</p>
            </div>
        </div>
        <!--**********************************
            Footer end
